...
<?php
        ...
        if (mysqli_connect_errno()) { // verificar se conexao teve sucesso, caso contrario voltara para index
           print ("erro banco");
            ...
            $consulta3 ="select * from descricao";
            $consulta4 ="select * from status";
            $consulta5 ="select * from proprietario";
            $consulta6 ="select * from posicao";
            $consulta7 ="select * from usuario";
